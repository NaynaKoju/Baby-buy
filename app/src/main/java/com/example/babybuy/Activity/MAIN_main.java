...
import com.example.babybuy.Fragments.frag_sizechart;
import com.example.babybuy.Fragments.frag_of_SMS;
import com.example.babybuy.Fragments.frag_of_user;
import com.example.babybuy.Fragments.frag_of_category;
import com.example.babybuy.Fragments.frag_of_productmngmnt;
...
public class MAIN_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(this.getResources().getColor(R.color.army));
        }
        ...
        loadFragment(new frag_of_category());
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.mproduct: {
                        loadFragment(new frag_of_productmngmnt());
                        break;
                    }

                    case R.id.msendsms: {
                        loadFragment(new frag_of_SMS());
                        break;
                    }

                    case R.id.msizechart: {
                        loadFragment(new frag_sizechart());
                        break;
                    }

                    case R.id.mmuser: {
                        loadFragment(new frag_of_user());
                        break;
                    }

                    case R.id.mlogout: {
                        startActivity(new Intent(MAIN_main.this, to_login.class));
                        SharedPreferences sp = getSharedPreferences("AUTH", MODE_PRIVATE);
                        sp.edit().remove("email").commit();
                        sp.edit().remove("password").commit();
                        Toast.makeText(MAIN_main.this, "Successfully Logout", Toast.LENGTH_SHORT).show();
                        break;
                    }
                }
                return true;
            ...
            case REQUEST_ID_MULTIPLE_PERMISSIONS: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.SEND_SMS)
                        ...
                        Toast.makeText(this, "Go to settings>enable permissions>OK", Toast.LENGTH_LONG).show();
                    }
                }
            }
        }
    ...
    private void showDialogOK(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(this)
                .setMessage(message)
                .setPositiveButton("Send", okListener)
