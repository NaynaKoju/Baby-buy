    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (fname.isEmpty() || lname.isEmpty() || email.isEmpty() || password.isEmpty() || cpassword.isEmpty()) {
                    Toast.makeText(registration.this, "Make sure you have entered all data", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                        ...
                        if (password.length() >= 8) {
                            ...
                            if (password.equals(cpassword)) {
                                ...
                                if (checkuser == false) {
                                    ...
                                    if (i == true) {
                                        ...
                                        startActivity(new Intent(registration.this, to_login.class));
                                    }

                                    //incase any problem occured
                                    else {
                                        Toast.makeText(registration.this, "Failed to update", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                            //incase password and confirm password
                                ...
                                Toast.makeText(registration.this, "confirm password doesn't match", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        //if password length doesn't match
                            ...
                            Toast.makeText(registration.this, "Enter 8 digit password", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        redirecttologin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(registration.this, "Redirecting to Login", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(registration.this, to_login.class));
            }
        });
    }
