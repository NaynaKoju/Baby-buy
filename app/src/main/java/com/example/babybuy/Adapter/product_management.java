...
public class product_management extends RecyclerView.Adapter<product_management.ViewHolder> {

    Context context;
    ArrayList<model_product> arrayList;

    public product_management(Context context, ArrayList<model_product> arrayList) {
    ...
    @NonNull
    @Override
    public product_management.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.product_rec_view, parent, false);
        product_management.ViewHolder viewHolder = new product_management.ViewHolder(v);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.pedit.setOnClickListener(v -> {
            AlertDialog.Builder editProduct = new AlertDialog.Builder(context);
